...
- `docs/home-lab-architecture.example.md` — invented lab diagram (includes example Uptime Kuma on kuma-host at `10.42.0.40` with status page slug `network`; Orbi names without last-octet IPs)
